...
import 'package:flutter_app_firsts/component/Chip/chip.dart';

class ChipIndexPage extends StatelessWidget {
  @override
  ...
  Widget MyBody(BuildContext context){
    ...
    return  GridView.count(
      ...
      children: <Widget>[
        JumpButton(context,new ChipPage(),"ChipPage"),
//        JumpButton(context,new ChipThemePage(),"ChipTheme"),
