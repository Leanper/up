...
import '../other/LifeCicyler2.dart' as e;
...
class _MyPage1State extends State<MyPage1> {
  ...
  Widget MyBody(BuildContext context) {
    return RaisedButton(
      onPressed: (){
        Navigator.push(context, new MaterialPageRoute(builder:(context)=>new e.MyPage1()));
      },
      child: Text("跳转"),
    );
  }
